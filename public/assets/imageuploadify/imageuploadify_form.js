    ...
    $.fn.imageuploadify = function(opts) {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          <button type="button" class="btn btn-default">Click để chọn ảnh</button>
        </div>
      </div>
      `);
          ...
          <button type='button' class='btn btn-danger glyphicon glyphicon-remove mdi mdi-delete-forever'></button>
          <div class='imageuploadify-details'>
            ...
            $(self).closest("form").on("submit", function(event) {
                $(`input[name="${self.name}"]`).val(totalFiles)
            });

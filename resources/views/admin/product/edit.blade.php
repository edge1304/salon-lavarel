        ...
        <div class="container">
            <form method="post" action="{{route("admin.product.update",['id' => $product->id])}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="product_name" value="{{$product->product_name}}" placeholder="Nhập tên sản phẩm" required>
                </div>
                <div class="form-group">
                    <label for="product_price">Seo image</label>
                    <input name="product_seo_image" value="{{$product->product_seo_image}}" class="form-control" type="text" placeholder="nhập link ảnh">
                </div>
                <div class="form-group">
                    <label for="product_price">Seo title</label>
                    <input name="product_seo_title" type="text" value="{{$product->product_seo_title}}" class="form-control" placeholder="nhập seo title">
                </div>
                <div class="form-group row">
                    <div class="col-6 col-md-6 col-xl-3 col-lg-3">
                        <label for="product_price">Giá nhập</label>
                        <input type="text" class="form-control integer" value="{{number_format($product->product_import_price)}}"  name="product_import_price" placeholder="Nhập giá sản phẩm" oninput="inputNumber()" required>
                    </div>
                    <div class="col-6 col-md-6 col-xl-3 col-lg-3">
                        <label for="product_price">Giá bán</label>
                        <input type="text" class="form-control integer"  value="{{number_format($product->product_price)}}"  name="product_price" placeholder="Nhập giá sản phẩm" oninput="inputNumber()" required>
                    </div>
                    <div class="col-6 col-md-6 col-xl-3 col-lg-3">
                        <label for="product_price">VAT</label>
                        <input type="text" class="form-control integer" value="{{number_format($product->product_vat)}}"   name="product_vat" placeholder="Nhập giá sản phẩm" oninput="inputNumber()" required>
                    </div>
                    <div class="col-6 col-md-6 col-xl-3 col-lg-3">
                        <label for="product_price">Chiết khấu</label>
                        <input type="text" class="form-control" value="{{number_format($product->product_tradiscount)}}"  name="product_tradiscount" placeholder="Nhập giá sản phẩm" oninput="inputNumber()" required>
                    </div>
                    <div class="col-6 col-md-6 col-xl-6 col-lg-6">
                        <label for="product_price">Giá bán ảo</label>
                        <input type="text" class="form-control integer" value="{{number_format($product->product_price_fake)}}"  name="product_price_fake" placeholder="Nhập giá sản phẩm" oninput="inputNumber()" required>
                    </div>
                    <div class="col-6 col-md-6 col-xl-6 col-lg-6">
                        <label for="product_price">Part thưởng</label>
                        <input type="text" class="form-control integer"   value="{{number_format($product->product_part)}}" name="product_part" placeholder="Nhập part thưởng" oninput="inputNumber()" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="editor" name="product_content"  class="form-control"></textarea>
                </div>
                <div class="form-group" >
                    <b>Ảnh sản phẩm</b>
...
@section('script')
    ...
    <script>
        ...
        CKEDITOR.instances.editor.setData(`{!!  $product->product_content !!}`);
    </script>
    <script>
